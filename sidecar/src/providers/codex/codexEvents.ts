...
function threadItem(params: unknown): ThreadItem {
...
function toolCall(item: ThreadItem): ToolCall | undefined {
...
function toolOutput(item: ThreadItem, streamed: string): string {
...
function patchText(changes: FileUpdateChange[]): string {
