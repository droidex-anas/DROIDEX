...
- Completed child waves retain their result previews until the parent accepts them. Pending and running siblings block delivery; manual and automatic compaction retry it on settlement. Stop and steer interruption never accept a wake. Accepted wakes use the ordinary background-turn error owner.
