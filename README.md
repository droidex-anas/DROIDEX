...
DROIDEX is a macOS desktop workspace for coding agents, including Factory Droid,
Claude Code, and Codex. It keeps chats, projects, terminals, browser sessions,
and agent work together in one app.
...
You need Node.js 22, npm, and at least one supported agent CLI: Factory Droid,
Claude Code, or Codex. DROIDEX can install the Factory Droid CLI during
onboarding if it is not already available.
